...
class SecurityConfigTest {
    ...
    void meShouldReturnUserWithValidToken() throws Exception{
        String token = tokenizationService.generateToken(ContentmunchUser.builder().username("testuser").password("password")
                .name("Contentmunch").email("mail@contentmunch.com").roles(Set.of(ContentmunchRole.ROLE_USER)).build());
